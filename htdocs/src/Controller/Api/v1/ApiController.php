...
class ApiController extends AbstractController
{
    ...
    public function getProducts(EntityManagerInterface $entityManager): JsonResponse
    {
        $products = $entityManager->createQueryBuilder()
            ->select('p.id', 'p.name', 'p.type', 'p.price', 'p.priceBulk')
            ->from('App\Entity\Product', 'p');
        return $this->json($products->getQuery()->getResult());
    }
    ...
    public function fvewvfevw(EntityManagerInterface $entityManager,
                              Request                $request,
